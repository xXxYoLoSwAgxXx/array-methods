...
upToTen.splice(2, 4, 3,4,5,6,7,8,9,10);
brownOnly.splice(0,7,'brown','brown', 'brown', 'brown', 'brown');
var orderedValuesNewLength = orderedValues.unshift(1,2,3);
var randomThingsArray = genericNumberArray.concat(colors);
var updatedOrders = orderQueue.concat({takeOut: 'lit'}, {takeOut:'fire'});
